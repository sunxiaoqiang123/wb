...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">请登录管理后台</p>
    @if(session('info'))
    ...
    <form action="/admin/dologin" method="post">
      ...
      <div class="row">  
        ...
        <div class="col-xs-5">
            <a onclick="javascript:re_captcha();" ><img style="height:32px;" src="{{ URL('kit/captcha/1') }}"  alt="验证码" title="刷新图片" width="100" height="40" id="c2c98f0de5a04167a9e427d883690ff6" border="0"></a>
          </div>
      </div>
      <div class="row">
        <div class="col-xs-8">
